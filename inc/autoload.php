...
if ( ! function_exists( 'cs_base_autoload' ) ) :
	...
	function cs_base_autoload( string $class ) {
		...
		// Set up file path.
		$class_path = CS_BASE_INC . 'classes/';
	...
	spl_autoload_register( 'cs_base_autoload' );
endif;
